...
public interface Odometry {
    ...
    /**
     * This is a method that should be called every update cycle. It's
     * called everytime voyager ticks, and it's used to allow the
     * odometry system to update itself. Without the odometry system
     * updating itself, the position reported by the odometry system
     * would be static, and that's not very useful, is it? This method
     * is meant to be overridden by the user, but it is not required.
     * <p>
     * If you're using an odometry system that doesn't need to update
     * itself, you can leave this method blank.
     */
    default void tick() {}
}
