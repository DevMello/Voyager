 ...
 * use cases, you shouldn't manually use this class' {@link #tick(Voyager)}
 * method - rather, you'd want to have an instance of {@link Voyager} tick
 * it instead in the {@link Voyager#tick()} method.
 *
 * <p>
 ...
 * of ideas, check out {@link RandomString#randomString(int)}.
 * </p>
 *
...
public class ListenerManager implements Tickable {
     ...
     */
    public ListenerManager(Voyager voyager) {
     ...
     */
    @Override
    public boolean tick(Voyager voyager) {
